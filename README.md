...
|---------|-------------|------|
| **Perfect Community API** | JWT 인증, MariaDB & Redis 연동 커뮤니티 API | [GitHub](https://github.com/Ahngbeom/Perfect-Community-API) |
| **MBTI Chat** | MBTI 기반 채팅 서비스 | [GitHub](https://github.com/Ahngbeom/MBTI-Chat) |
